...
VALUES ('admin1', 'AdminNick1', 'ADMIN', crypt('password1!', gen_salt('bf')), NOW(), NOW(), null),
       ('admin2', 'AdminNick2', 'ADMIN', crypt('password1!', gen_salt('bf')), NOW(), NOW(), null),
       ('admin3', 'AdminNick3', 'ADMIN', crypt('password1!', gen_salt('bf')), NOW(), NOW(), null),
       ('admin4', 'AdminNick4', 'ADMIN', crypt('password1!', gen_salt('bf')), NOW(), NOW(), null);
